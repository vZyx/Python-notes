...
class LinkedList:
    ...
    def middle_value(self):
        # The idea is simple but smart using Tortoise and the Hare Algorithm
        # Uses 2 nodes:
        # The first 'slow' moves normally step by step
        # The second 'fast' jump 2 steps each time!
        # If the list has e.g. 10 elements
        # When the slow in the middle e.g. 5, fast is at the double 10
